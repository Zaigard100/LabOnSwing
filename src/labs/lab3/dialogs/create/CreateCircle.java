...
import labs.lab3.primitives.Circle;
...
public class CreateCircle extends JDialog {
    ...
    public CreateCircle(){
        super(Lab3.getjFrame(),"Create Circle",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x<Lab3.getWindows_w()-diameter) && (y>0) && (y<Lab3.getWindows_h()-diameter) && (diameter>0) && (diameter<Math.min(Lab3.getWindows_w()-x,Lab3.getWindows_h()-y))) {
