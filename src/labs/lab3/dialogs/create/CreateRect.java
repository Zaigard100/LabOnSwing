...
import labs.lab3.primitives.Rect;
...
public class CreateRect extends JDialog {
    ...
    public CreateRect(){
        super(Lab3.getjFrame(),"Create Rect",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x<Lab3.getWindows_w() - diameter1) && (y>0) && (y<Lab3.getWindows_h()-diameter2) && (diameter1>0)&& (diameter2>0) && (diameter1<Lab3.getWindows_w()-x) && (diameter2<Lab3.getWindows_h()-y)) {
                    Utils.getRects().add(new Rect(new Point(x,y), diameter1,diameter2, fill, new Color(r, g, b)));
                }
                xField.setText("");
                yField.setText("");
                widthField.setText("");
