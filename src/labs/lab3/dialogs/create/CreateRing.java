...
import labs.lab3.primitives.Ring;
...
public class CreateRing extends JDialog {
    ...
    public CreateRing(){
        super(Lab3.getjFrame(),"Create Ring",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x<Lab3.getWindows_w()-Math.max(diameter1,diameter2)) && (y>0) && (y<Lab3.getWindows_h()-Math.max(diameter1,diameter2)) && (diameter1>0)&& (diameter2>0) && (Math.max(diameter1,diameter2)<Math.min(Lab3.getWindows_w()-x,Lab3.getWindows_h()-y))) {
