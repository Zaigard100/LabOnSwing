...
import labs.lab3.primitives.Line;
...
public class CreateLine extends JDialog {
    ...
    public CreateLine(){
        super(Lab3.getjFrame(),"Create Line",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x<Lab3.getWindows_w()) && (y>0) && (y<Lab3.getWindows_h()) && (x1>0) && (x1<Lab3.getWindows_w()) && (y1>0) && (y1<Lab3.getWindows_h()) && (r>=0&&g>=0&&b>=0&&r<=255&&g<=255&&b<=255)) {
