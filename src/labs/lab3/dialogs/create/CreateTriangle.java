...
import labs.lab3.primitives.Triangle;
...
public class CreateTriangle extends JDialog {
    ...
    public CreateTriangle(){
        super(Lab3.getjFrame(),"Create Triangle",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x1>0) && (x1<Lab3.getWindows_w()) && (y1>0) && (y1<Lab3.getWindows_h()) && (x2>0) && (x2<Lab3.getWindows_w()) && (y2>0) && (y2<Lab3.getWindows_h()) && (x3>0) && (x3<Lab3.getWindows_w()) && (y3>0) && (y3<Lab3.getWindows_h()) && (r>=0&&g>=0&&b>=0&&r<=255&&g<=255&&b<=255)) {
