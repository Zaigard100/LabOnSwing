...
public class CreateFigure extends JDialog {
    ...
    public void createFigure() {
        int x = Lab5.parseInt(xF.getText(),-1);
        int y = Lab5.parseInt(yF.getText(),-1);
        int x1 = Lab5.parseInt(x1F.getText(),-1);
        int y1 = Lab5.parseInt(y1F.getText(),-1);
        int x2 = Lab5.parseInt(x2F.getText(),-1);
        int y2 = Lab5.parseInt(y2F.getText(),-1);
        int dw = Lab5.parseInt(dwF.getText(),-1);
        int dw1 = Lab5.parseInt(dw1F.getText(),-1);
        int dh = Lab5.parseInt(dhF.getText(),-1);
        int r = Lab5.parseInt(rF.getText(),-1);
        int g = Lab5.parseInt(gF.getText(),-1);
        int b = Lab5.parseInt(bF.getText(),-1);
