...
import labs.lab5.primitives.Oval;
...
public class CreateOval extends JDialog {
    ...
    public CreateOval(){
        super(Lab4.getjFrame(),"Create Oval",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x< Lab4.getWindows_w() - diameter1) && (y>0) && (y< Lab4.getWindows_h()-diameter2) && (diameter1>0)&& (diameter2>0) && (diameter1< Lab4.getWindows_w()-x) && (diameter2< Lab4.getWindows_h()-y)) {
                    Utils.getFigures().add(new Oval(new Point(x,y), diameter1,diameter2, fill, new Color(r, g, b)));
                }
                xField.setText("");
                yField.setText("");
                diameter1Field.setText("");
