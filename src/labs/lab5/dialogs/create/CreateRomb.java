...
import labs.lab5.primitives.Romb;
...
public class CreateRomb extends JDialog {
    ...
    public CreateRomb(){
        super(Lab5.getjFrame(),"Create Romb",true);
        ...
        create.addActionListener(e -> {
            try {
                ...
                if((x>0) && (x< Lab5.getWindows_w() - diameter1) && (y>0) && (y< Lab5.getWindows_h()-diameter2) && (diameter1>0)&& (diameter2>0) && (diameter1< Lab5.getWindows_w()-x) && (diameter2< Lab5.getWindows_h()-y)) {
                    Utils.getFigures().add(new Romb(new Point(x,y), diameter1,diameter2, fill, new Color(r, g, b)));
                }
                xField.setText("");
                yField.setText("");
                widthField.setText("");
